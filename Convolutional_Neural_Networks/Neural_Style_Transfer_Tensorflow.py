...
def save_image(path, image):
    image = image + CONFIG.MEANS
    image = np.clip(image[0], 0, 375).astype('uint8')
...
content_image = scipy.misc.imread("images/style/content500.jpg")
content_image = reshape_and_normalize_image(content_image)

style_image = scipy.misc.imread("images/style/fabgao_style-500.jpg")
